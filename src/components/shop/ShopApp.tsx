...
export default function ShopApp() {
  ...
  return <div className="min-h-screen bg-white text-[#07090c]">
    ...
    <section className="hidden border-b bg-white md:block"><div className="mx-auto grid max-w-7xl grid-cols-4 divide-x">{[{Icon:ShieldCheck,title:"Produits 100% originaux",description:"Garantie constructeur"},{Icon:Truck,title:"Livraison rapide",description:"Côte d'Ivoire & Afrique"},{Icon:CreditCard,title:"Paiement sécurisé",description:"Mobile Money prochainement"},{Icon:Headphones,title:"Support technique",description:"Experts à votre écoute"}].map(({Icon:FeatureIcon,title:featureTitle,description:featureDescription})=><div key={featureTitle} className="flex items-center gap-3 px-5 py-3.5"><FeatureIcon className="h-5 w-5 shrink-0 text-[#ed1c24]"/><div><p className="text-xs font-black">{featureTitle}</p><p className="text-[10px] text-[#73777d]">{featureDescription}</p></div></div>)}</div></section>
